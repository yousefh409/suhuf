...
export default function Nav() {
  ...
  return (
    <nav className="sticky top-0 z-50 flex items-center justify-between w-full px-16 py-7 bg-parchment-light/90 backdrop-blur-md">
      <a href="/" className="font-serif italic text-[22px] text-ink leading-7">
        suhuf
      </a>
      ...
      {menuOpen && (
        <div className="absolute top-full left-0 right-0 bg-parchment-light p-6 flex flex-col gap-4 md:hidden border-t border-ink/5">
          <a href="#features" className="text-sm text-ink/60">
            Features
          </a>
          <a href="#pricing" className="text-sm text-ink/60">
            Pricing
          </a>
          <a
            href="#waitlist"
